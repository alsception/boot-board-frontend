  ...
  template: `
    <section class="card-container lgc-{{bbCard.color}}">
      ...
      <div class="card card-meta-container"  [ngClass]="{ 'hidden': !showCards }">
        ...
        <div class="card-meta" matTooltip="Position" matTooltipPosition="above">
          <span class="material-icons md-12">tag</span>{{bbCard.position}}
        </div>
      </div>

      <div class="card-footer-container" [ngClass]="{ 'hidden': !showCards }">
